<?php
    ...
    $w_routes = array(
        ...
        // User
        ['GET|POST', '/user/login', 'User#login', 'user_login'],                           	// login with credentials (email + password)
        ['GET|POST', '/user/logout', 'User#logout', 'user_logout'],							// logout
        ['GET|POST', '/user/register', 'User#register', 'user_register'],                  	// register (email + password + passwordRepeat [+ captcha])
        ['GET|POST', '/user/reset-password', 'User#resetPassword', 'user_reset_password'], 	// reset password (email [+ captcha])
        ['GET|POST', '/user/profile', 'User#profile', 'user_profile'],                		// display profile, modify / delete account
		['GET|POST', '/user/forgotten-pwd', 'User#recovery_pwd', 'user_recovery_pwd'],		//
		['GET|POST', '/user/renew-pwd/[*:token]/[*:userEmail]', 'User#renew_pwd', 'user_renew_pwd'],
        
		//Private area
		['GET|POST', '/user/profile/modify', 'User#modify', 'user_modify'],
